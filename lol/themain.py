...
def install_alpine_linux():
    ...
    if "alpine-desktop" in container_check.stdout:
        ...
        subprocess.run(["docker", "exec", "alpine-desktop", "apk", "add", "xfce4", "xfce4-terminal", "xfce4-panel", "xfce4-session", "xfce4-settings", "dbus", "x11vnc", "tigervnc", "novnc", "firefox-esr", "geckodriver"], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
